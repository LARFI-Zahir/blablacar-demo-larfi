...
import { IconBack, IconChevronRight, IconPersonPlaceholder, IconPlusCircle } from "./icons";
import CoupDePouceBadge from "./CoupDePouceBadge";

const PROFILE_STEPS = 6;

// Vu par le conducteur newbie lui-même (écran "À propos de vous").
export default function DriverPublicProfile({ recommendation, drivers, onClose }) {
